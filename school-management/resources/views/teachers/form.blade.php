                    ...
                    <div class="form-grid form-grid-2">
                        ...
                        <div>
                            ...
                            <select name="designation" class="form-select" required>
                                @foreach(['প্রধান শিক্ষক','সহকারী প্রধান শিক্ষক','সহকারী শিক্ষক','প্রভাষক','মাওলানা','হাফেজ','অফিস সহকারী','পিয়ন'] as $d)
                                <option value="{{ $d }}" {{ old('designation', $teacher->designation ?? '') === $d ? 'selected' : '' }}>{{ $d }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
