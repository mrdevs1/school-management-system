    ...
    <div class="card-body" style="padding:16px 22px;">
        <div class="filter-bar">
            ...
            <div style="margin-left:auto;">
                <form method="POST" action="{{ route('salaries.pay-all') }}" onsubmit="return confirm('এই মাসের সব বাকি বেতন পরিশোধ করবেন?')">
                    @csrf
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right; font-family:var(--font-en); color:#16a34a;">
                        {{ $payment ? '৳'.number_format($payment->bonus) : '—' }}
                    </td>
                    <td style="text-align:right; font-family:var(--font-en); color:#dc2626;">
                        {{ $payment ? '৳'.number_format($payment->deduction) : '—' }}
                    </td>
                    <td style="text-align:right; font-family:var(--font-en); font-weight:700; color:var(--green);">
                        ৳{{ number_format($payment?->net_salary ?? $teacher->salary) }}
                    </td>
                    ...
                    <td>
                        <div style="display:flex; gap:5px; justify-content:center;">
                            @if($payment)
                            <a href="{{ route('salaries.slip', $payment->id) }}" class="btn btn-icon btn-outline btn-sm" data-tooltip="বেতন স্লিপ" target="_blank">
            ...
            <div class="modal-body">
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-bottom:14px;">
                    <div>
                        ...
                        <input type="number" name="basic_salary_display" id="modalBasicSalary" class="form-control" readonly style="background:var(--bg);">
                    </div>
                    <div>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:12px; margin-bottom:14px;">
                    ...
                    <div>
                        ...
                        <input type="number" name="net_salary_display" id="modalNetSalary" class="form-control" readonly style="background:var(--bg); font-weight:700; color:var(--green);">
                    </div>
                </div>
