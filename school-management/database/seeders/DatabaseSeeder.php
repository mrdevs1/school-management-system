...
use App\Models\{User, Classes, Section, Session, FeeCategory, Teacher, Student};
...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── School Classes ────────────────────────────────
        $schoolClasses = [
            ['প্রথম শ্রেণী',   'Class 1',  1, 'school'],
            ['দ্বিতীয় শ্রেণী', 'Class 2',  2, 'school'],
            ['তৃতীয় শ্রেণী',  'Class 3',  3, 'school'],
            ['চতুর্থ শ্রেণী',  'Class 4',  4, 'school'],
            ['পঞ্চম শ্রেণী',   'Class 5',  5, 'school'],
            ['ষষ্ঠ শ্রেণী',    'Class 6',  6, 'school'],
            ['সপ্তম শ্রেণী',   'Class 7',  7, 'school'],
            ['অষ্টম শ্রেণী',   'Class 8',  8, 'school'],
            ['নবম শ্রেণী',     'Class 9',  9, 'school'],
            ['দশম শ্রেণী',     'Class 10',10, 'school'],
        ];
        ...
        // ── Madrasa Classes ───────────────────────────────
        $madrasaClasses = [
            ['ইবতেদায়ী ১ম শ্রেণী',  'Ibtedayi 1',  1],
            ['ইবতেদায়ী ২য় শ্রেণী',  'Ibtedayi 2',  2],
            ['ইবতেদায়ী ৩য় শ্রেণী',  'Ibtedayi 3',  3],
            ['ইবতেদায়ী ৪র্থ শ্রেণী', 'Ibtedayi 4',  4],
            ['ইবতেদায়ী ৫ম শ্রেণী',  'Ibtedayi 5',  5],
            ['দাখিল ৬ষ্ঠ শ্রেণী',    'Dakhil 6',    6],
            ['দাখিল ৭ম শ্রেণী',      'Dakhil 7',    7],
            ['দাখিল ৮ম শ্রেণী',      'Dakhil 8',    8],
            ['দাখিল ৯ম শ্রেণী',      'Dakhil 9',    9],
            ['দাখিল ১০ম শ্রেণী',     'Dakhil 10',  10],
            ['আলিম ১ম বর্ষ',         'Alim 1',     11],
            ['আলিম ২য় বর্ষ',         'Alim 2',     12],
        ];
        ...
        foreach ($fees as [$name, $amount, $frequency, $desc]) {
            FeeCategory::create(compact('name','amount','frequency','desc') + ['description'=>$desc]);
        }
        ...
        foreach ($teachers as $i => [$name, $gender, $qual, $des, $salary]) {
            Teacher::create([
                ...
                'designation'   => $des,
                'salary'        => $salary,
                'phone'         => '017' . str_pad($i, 8, rand(0,9)),
        ...
        if ($class6 && $sec) {
            ...
            foreach ($names as $i => [$name, $gender]) {
                Student::create([
                    'name'           => $name,
                    'gender'         => $gender,
                    'date_of_birth'  => now()->subYears(12)->subDays(rand(0,365)),
                    'father_name'    => 'মোঃ আব্দুল করিম',
                    'mother_name'    => 'বেগম সাহেবা',
                    'guardian_phone' => '01711' . str_pad($i, 6, rand(0,9)),
